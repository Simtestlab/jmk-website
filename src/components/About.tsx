            ...
            <Card className="bg-gradient-card shadow-card border-0 hover:shadow-glow transition-spring">
              <CardContent className="p-6 sm:p-8">
                <div className="flex flex-col sm:flex-row items-start sm:items-center mb-4 sm:mb-6">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full overflow-hidden mb-3 sm:mb-0 sm:mr-6">
                    <img
                      src={visionImg}
                      alt="Vision"
                      className="w-full h-full object-cover"
            ...
            <div className="space-y-4 sm:space-y-6">
              {milestones.map((milestone, index) => (
                <div key={index} className="relative">
                  ...
                  <div
                    className={`ml-10 sm:ml-14 md:ml-0 md:w-5/12 ${
