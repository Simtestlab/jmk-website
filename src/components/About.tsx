      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          ...
          <p className="text-sm sm:text-base md:text-lg text-muted-foreground max-w-4xl mx-auto leading-relaxed">
            With over a decade of industry experience and a proven portfolio of <span className="text-primary font-semibold">500+ MW</span> of clean
              ...
              <div className="grid lg:grid-cols-2 gap-0">
                <div className="p-6 sm:p-8 lg:p-8">
                  ...
                  <div className="space-y-3 sm:space-y-4 text-sm sm:text-base text-muted-foreground">
                    <p>
                      Located in India's largest wind energy corridor, <strong>Muppandal Belt, Tamil Nadu</strong>, we have been
                    ...
                    <p>
                      Our team of <strong>150+ professionals</strong> brings <strong>200+ portfolios</strong> of work experience in
                      wind, solar, and related industries, enabling us to
                      deliver comprehensive energy solutions across India.
                    </p>
                    <p>
                      We maintain wind farms totaling close to <strong>400MW</strong> and have successfully completed
                    ...
                    <div className="text-center text-white w-full px-4 sm:px-6">
                      <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
                        <div className="backdrop-blur-sm bg-white/10 rounded-lg p-3 sm:p-4 border border-white/20 hover:bg-white/20 transition-all duration-300">
                          ...
                          <div className="text-xs sm:text-sm opacity-90">Wind Farms Maintained</div>
                        </div>
                        <div className="backdrop-blur-sm bg-white/10 rounded-lg p-3 sm:p-4 border border-white/20 hover:bg-white/20 transition-all duration-300">
                          <div className="text-lg sm:text-xl lg:text-2xl font-bold mb-1">100MW</div>
                          <div className="text-xs sm:text-sm opacity-90">Solar Projects Completed</div>
                        </div>
                        <div className="backdrop-blur-sm bg-white/10 rounded-lg p-3 sm:p-4 border border-white/20 hover:bg-white/20 transition-all duration-300">
                          <div className="text-lg sm:text-xl lg:text-2xl font-bold mb-1">150+</div>
                          <div className="text-xs sm:text-sm opacity-90">Team Professionals</div>
                        </div>
                        <div className="backdrop-blur-sm bg-white/10 rounded-lg p-3 sm:p-4 border border-white/20 hover:bg-white/20 transition-all duration-300">
            ...
            <CardContent className="p-6 sm:p-8">
              <div className="text-center mb-6 sm:mb-8">
                <div className="flex flex-col sm:flex-row items-center justify-center mb-4">
                  ...
                  <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground">Innovation & Technology Partnership</h2>
                </div>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6 sm:gap-8 items-center">
                ...
                <div className="bg-white/50 dark:bg-black/20 p-4 sm:p-6 rounded-lg">
                  ...
                  <p className="text-sm sm:text-base text-muted-foreground mb-3 sm:mb-4">This global transition is vital to safeguard our planet, reduce air pollution, slow rising global temperatures, and counter the growing threats of climate change.</p>
        ...
        <div className="mb-12 sm:mb-16">
          <div className="grid gap-6 lg:gap-8 items-center lg:grid-cols-[300px_1fr] xl:grid-cols-[320px_1fr]">
            ...
            <div className="p-4 lg:p-6 order-1 lg:order-2">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mb-2">Mr. Muthu Kumar J</h2>
              <h3 className="text-base sm:text-lg md:text-xl text-primary font-semibold mb-3 sm:mb-4">Founder and Managing Director</h3>
        ...
        <div className="mb-12 sm:mb-16">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mb-3 sm:mb-4">Our Foundation</h2>
            <p className="text-base sm:text-lg text-muted-foreground max-w-3xl mx-auto">Built on strong values and guided by a clear vision for a sustainable future</p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 mb-8 sm:mb-12">
            <Card className="bg-gradient-to-br from-card to-card/50 shadow-lg border-0 hover:shadow-xl transition-all duration-300">
              <CardContent className="p-6 sm:p-8">
                ...
                <h4 className="text-lg sm:text-xl font-semibold text-primary mb-3 sm:mb-4">Green and Clean mother earth for our children.</h4>
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">We dream of a world where every child breathes clean air and grows up on a green and thriving planet. Our mission goes beyond power generation—it's about preserving a living planet for future generations.</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-card to-card/50 shadow-lg border-0 hover:shadow-xl transition-all duration-300">
              <CardContent className="p-6 sm:p-8">
                ...
                <p className="text-base sm:text-lg font-semibold text-primary mb-3 sm:mb-4 leading-relaxed">Be an organization constantly focused on catering global energy needs through green and clean energy led by scientific innovations governed by ethical values.</p>
                <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">Dedicated to meeting global energy needs through sustainable solutions, driven by scientific innovation and guided by strong ethical values.</p>
              </CardContent>
            </Card>
          </div>
          ...
          <Card className="bg-gradient-to-r from-secondary/30 via-secondary/20 to-secondary/30 shadow-lg border-0">
            <CardContent className="p-6 sm:p-8">
              <div className="text-center mb-6 sm:mb-8">
                <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-2">Our Core Values</h3>
                <p className="text-base sm:text-lg text-primary font-medium">Innovation • Integrity • Quality • Sustainability</p>
              </div>
        ...
        <div className="mb-12 sm:mb-16">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mb-3 sm:mb-4">Organizational Hierarchy</h2>
            <p className="text-base sm:text-lg text-muted-foreground max-w-3xl mx-auto">Our leadership structure designed for excellence in renewable energy operations</p>
          </div>
        ...
        <div className="mb-12 sm:mb-16">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-foreground mb-2 sm:mb-3">Milestones We Reach</h2>
          <p className="text-base sm:text-lg text-center text-muted-foreground mb-6 sm:mb-8">Our journey of growth and innovation in renewable energy</p>
            ...
            <div className="space-y-4 sm:space-y-6">
              {milestones.map((milestone, index) => (
                <div key={index} className="relative">
                  ...
                  <div className={`ml-10 sm:ml-14 md:ml-0 md:w-5/12 ${index % 2 === 0 ? "md:mr-auto" : "md:ml-auto"}`}>
